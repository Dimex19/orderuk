...
const Footer = () => {
  return (
    <div className='pt-[81px] bg-[#D9D9D9]'>
        <div className="pl-[100px] pr-[100px] mb-[58px] flex justify-between">
            <div className="f">
            ...
            <div className="flex gap-10">
                <div className="">
                    <p className="text-[18px] font-bold">Get Exclusive Deals in your Inbox</p>
                    <div className="h-[57px] relative w-[481px] mt-[23px]">
                        <input type="text" className='w-[481px] h-[59px] p-[20px] rounded-[120px] bg-[#bdbdbd] text-black'/>
                        <Button text='Subscribe' className='bg-[#FC8A06] w-[171px] h-[60px] rounded-[120px] text-white absolute right-0'/>
                    </div>
                    <p className="font-normal text-[13px] mt-3 ml-[30px]">we wont spam, read our email policy</p>
                    <div className="flex gap-[14px] mt-[21px] ml-[30px]">
        ...
        <div className="pl-[100px] pr-[100px] py-5 flex justify-between bg-[#03081F] text-white text-[15px]">
            <p className="g">Order.uk Copyright 2024, All Rights Reserved.</p>
            <div className="flex gap-10">
