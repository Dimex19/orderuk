...
const Service = () => {
  ...
  return (
    <div>
        <div className="ml-[100px] mr-[100px] pl-[129px] pr-[108px] pb-[115px] pt-[129px] bg-[#D9D9D9] rounded-[12px]">
            ...
            <div className="flex bg-[#03081F] pl-[72px] rounded-xl">
                ...
                <div className='flex flex-col items-center'>
                    <div className="flex gap-5 pt-[88px] ml-[31px]">
                        {data.map((item, index) => (
        ...
        <div className="flex justify-around items-center ml-[100px] mr-[100px] mt-[44px] mb-[45px] bg-[#FC8A06] rounded-xl">
            ...
            <div className="border border-white h-[100px]"></div>
            <div className="flex flex-col items-center text-white pt-[20px] pb-[16px]">
