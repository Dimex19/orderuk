...
const Download = () => {
  return (
    <div>
      ...
      <div className=" w-[50%] h-[611px] flex items-end z-10 border border-red-600">
      ...
      <div className="flex flex-col absolute right-0 w-[60%] h-full items-center border border-black">
    ...
    {/* Mobile */}
      <div className="md:hidden">
        ...
        <p className="text-[44px] pr-9 text-black font-medium"><span className="text-[#FC8A06] underline">Personalised </span> & Instant</p>
        ...
        <div className="relative w-[100%] h-[611px] flex items-end border border-red-600">
          <img src="/assets/friends1.png" alt="" className="absolute bottom-0 left-0" />
          <img src="/assets/friends2.png" alt="" className="absolute bottom-0 left-4" />
      </div>
      </div>
